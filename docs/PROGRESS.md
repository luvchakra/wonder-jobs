...
- ⬜ 3.2 automation-level relabeling, 3.6 remaining misleading-copy fixes, 3.1/3.3 Ask Wonder + natural-language scheduling, 4.2 visual state matrix, 4.3/4.4 migration guardrails + capability preservation, mobile verification, Phase 5 Playwright + final audit — not started yet.
