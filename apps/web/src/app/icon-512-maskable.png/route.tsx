...
/**
 * PWA manifest icon (512×512, purpose "maskable"): Android crops adaptive
 * icons to its own shape, so the mark is padded well inside the safe zone
 * (roughly 45% of the frame width) instead of filling the canvas edge to edge.
 */
export function GET() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="230" height="230" viewBox="0 0 32 32">
