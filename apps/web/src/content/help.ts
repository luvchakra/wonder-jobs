...
export const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    body: [
      ...
      "Everything you enter becomes your Career Profile. Wonder scores every real posting against it, so honest answers give better matches. You can refine it any time under Career Profile.",
      "From Home, press Find opportunities and tell Wonder what you're looking for in your own words — for example “Senior product roles in Bengaluru or remote, preferably fintech”. Before anything runs, Wonder shows what it read from your words (roles, places, industry preference) and where each came from. It then searches live job sources, removes duplicates, compares each posting with your Career Profile, checks hiring signals, puts what deserves your attention first, prepares Application Packs for the top roles and asks for your review.",
  ...
  },
  {
    ...
    body: [
      "Career Profile is your name, headline, career goal, level and years of experience, skills (each rated 1–5), industries, preferred locations, minimum salary, strengths and growth areas.",
      ...
      "Filling it in from a resume: **Import from resume** on the Career Profile page (and during onboarding) reads a PDF, Word file or pasted text and suggests a headline, level, years, skills, industries and locations. Every suggestion shows the words it came from, you tick what to keep, and nothing changes until you apply it. Your career goal, salary and work modes are never guessed. The file is read and discarded — Wonder does not store it. A scanned or image-only PDF has no text in it, so Wonder says so and asks you to paste instead.",
